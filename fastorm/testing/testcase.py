...
import unittest
from typing import Any, Dict, Optional, List, Type, Union, TYPE_CHECKING
...
class TestCase(unittest.IsolatedAsyncioTestCase):
    ...
    def assertListContainsInstance(
        self, 
        lst: List[Any], 
        instance_type: Type
    ) -> None:
        ...
        self.assertTrue(
            found, 
            f"列表中未找到类型 {instance_type.__name__} 的实例"
        )
