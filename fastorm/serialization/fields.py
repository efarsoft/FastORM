...
class FieldConfig:
    ...
    case_transform: str | None = None  # "lower", "upper", "title", "camel", "snake"
...
class FieldMapping:
    ...
    def add_transformer(self, transformer: Callable[[Any], Any]) -> "FieldMapping":
        """添加值转换器"""
        self.transformers.append(transformer)
        return self

    def add_condition(self, condition: Callable[[Any], bool]) -> "FieldMapping":
        """添加条件"""
...
class FieldTransformer:
    ...
    def register_transformer(
        self, field_name: str, transformer: Callable[[Any], Any]
    ) -> None:
        """注册字段转换器"""
...
class FieldMappingRegistry:
    ...
    def register_field_config(self, field_name: str, config: FieldConfig) -> None:
        """注册字段配置"""
    ...
    def register_field_mapping(self, mapping_name: str, mapping: FieldMapping) -> None:
        """注册字段映射"""
        self._field_mappings[mapping_name] = mapping

    def register_transformer(
        self, transformer_name: str, transformer: FieldTransformer
    ) -> None:
        """注册转换器"""
    ...
    def get_field_mapping(self, mapping_name: str) -> FieldMapping | None:
        """获取字段映射"""
        return self._field_mappings.get(mapping_name)

    def get_transformer(self, transformer_name: str) -> FieldTransformer | None:
        """获取转换器"""
    ...
    def create_serialization_field(
        self, field_name: str, config: FieldConfig | None = None
    ) -> SerializationField:
        """创建序列化字段"""
        ...
        return SerializationField(
            config=effective_config, source_name=field_name, target_name=target_name
        )
...
def create_dict_transformer(
    key_transformer: Callable[[Any], str] | None = None,
    value_transformer: Callable[[Any], Any] | None = None,
    exclude_none: bool = True,
