...
class XMLFormatter(BaseFormatter):
    ...
    def _build_xml_element(
        self, parent: ET.Element, data: Any, item_name: str = "item"
    ) -> None:
        """构建XML元素"""
    ...
    def _parse_xml_element(self, element: ET.Element) -> dict[str, Any] | str:
        """解析XML元素"""
...
class CSVFormatter(BaseFormatter):
    ...
    def parse(
        self, content: str, delimiter: str = ",", quotechar: str = '"', **kwargs
    ) -> list[dict[str, Any]]:
        """解析CSV内容"""
        ...
        try:
            ...
            reader = csv.DictReader(
                input_stream, delimiter=delimiter, quotechar=quotechar, **kwargs
            )
    ...
    def _flatten_dict(
        self, data: dict[str, Any], prefix: str = "", separator: str = "."
    ) -> dict[str, str]:
        """扁平化字典"""
...
class FormatterRegistry:
    ...
    def register_formatter(
        self, name: str, formatter: BaseFormatter, mime_types: list[str] | None = None
    ) -> None:
        """注册格式化器"""
    ...
    def get_formatter(self, name: str) -> BaseFormatter | None:
        """获取格式化器"""
        return self._formatters.get(name)

    def get_formatter_by_mime_type(self, mime_type: str) -> BaseFormatter | None:
        """根据MIME类型获取格式化器"""
    ...
    def format_data(self, data: Any, format_name: str, **kwargs) -> str:
        """格式化数据"""
    ...
    def parse_data(self, content: str, format_name: str, **kwargs) -> Any:
        """解析格式化的数据"""
    ...
    def _register_builtin_formatters(self) -> None:
        ...
        self.register_formatter(
            "json", json_formatter, ["application/json", "text/json"]
        )

        # XML格式化器
        xml_formatter = XMLFormatter()
        self.register_formatter("xml", xml_formatter, ["application/xml", "text/xml"])

        # CSV格式化器
        csv_formatter = CSVFormatter()
        self.register_formatter("csv", csv_formatter, ["text/csv", "application/csv"])
