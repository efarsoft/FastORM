...
class FillableMixin:
    ...
    def fill_attributes(
        ...
        """
        filtered_attrs = self.filter_fillable_attributes(
            attributes, force_fill
        )
    ...
    async def make(
        ...
        """
        filtered_attrs = cls.filter_fillable_attributes(
            attributes, force_fill
        )
    ...
    def fill(cls, *attributes_list: List[Dict[str, Any]]):
        ...
        """
        return [
            cls.make(attributes, force_fill=False)
