...
class SoftDeleteMixin:
    ...
    def set_deleted_at(self, value: Optional[datetime]) -> None:
        """设置删除时间
    ...
    @classmethod
    def get_soft_delete_column(cls) -> Optional[str]:
        """获取软删除字段名
    ...
    def format_deleted_at(self, format_str: str = "%Y-%m-%d %H:%M:%S") -> Optional[str]:
        """格式化删除时间
