...
class PydanticIntegrationMixin:
    ...
    __hidden_fields__: Optional[List[str]] = None
    __pydantic_schema__: Optional[Type[BaseModel]] = None
    ...
    def from_pydantic(cls, 
                     ...
                     validate: bool = True) -> 'PydanticIntegrationMixin':
    ...
    def create_from_pydantic(cls,
        ...
        if validate:
            ...
            validated_data = create_schema.model_validate(
    ...
    def validate_with_pydantic(self, 
                             raise_error: bool = True) -> Union[bool, Dict[str, Any]]:
        """使用Pydantic验证当前实例
    ...
    def from_json(cls, 
                 json_str: str,
                 validate: bool = True,
                 for_create: bool = False) -> 'PydanticIntegrationMixin':
        """从JSON字符串创建实例
    ...
    @classmethod
    def get_pydantic_json_schema(cls, 
                               for_create: bool = False) -> Dict[str, Any]:
