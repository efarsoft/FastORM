...
class PerformanceDashboard:
    ...
    def _display_query_stats(self) -> None:
        ...
        if stats.total_queries > 0:
            success_rate = (stats.total_queries - stats.failed_queries) / stats.total_queries
    ...
    def _display_system_metrics(self) -> None:
        ...
        if metrics_summary.get('system'):
            ...
            if system.get('load_average'):
                ...
                print(f"📈 负载: {load_avg[0]:.2f}, {load_avg[1]:.2f}, {load_avg[2]:.2f}")
...
class ConsoleCommands:
    ...
    def _status(self, args: List[str]) -> bool:
        ...
        collector_status = "运行中" if self.dashboard.metrics_collector._collecting else "已停止"
...
def start_interactive_dashboard(monitor: Optional[PerformanceMonitor] = None) -> None:
    """启动交互式仪表板"""
...
def start_realtime_dashboard(monitor: Optional[PerformanceMonitor] = None,
