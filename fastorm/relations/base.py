...
from typing import Any, Generic, TypeVar, Type, Optional, Union, TYPE_CHECKING
        ...
        try:
            ...
            if hasattr(registry, '_class_registry'):
                for cls in registry._class_registry.values():
                    if hasattr(cls, '__name__') and cls.__name__ == self._model_class_name:
                        return cls
