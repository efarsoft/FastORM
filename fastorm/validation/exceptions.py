...
class ModelValidationError(ValidationError):
    ...
    def __init__(
        ...
        model_name: str,
        message: str,
        field_errors: list[FieldValidationError] | None = None,
    ...
    def get_field_errors(self, field: str) -> list[FieldValidationError]:
        """获取特定字段的错误"""
        return [error for error in self.field_errors if error.field == field]
    ...
    def __str__(self) -> str:
        base_message = f"Model validation error in {self.model_name}: {self.message}"
...
class AsyncValidationError(ValidationError):
    ...
    def __init__(
        ...
        field: str | None = None,
        value: Any | None = None,
        async_validator_name: str | None = None,
